...
- [Getting started](getting-started.md) — install, first user, login, JWT, protected routes.
- [Architecture](architecture.md) — layers, types, data flow, the generics model.
